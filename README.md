...
- **Seguridad** con bcryptjs, helmet, CORS y rate limiting
...
| Jest + supertest (test) | `^30.3.0` / `^7.2.2` | Tests unitarios e integración del backend |
...
| Vitest + @testing-library/react | `^4.1.0` / `^16.3.2` | Testing de componentes frontend |
...
- **Contraseñas:** hasheadas con bcryptjs (10 rondas) mediante hook `pre('save')` de Mongoose.
...
| `password` | String | Requerido, min. 6 chars, `select: false`, hasheado con bcryptjs |
