...
Proyecto Full-Stack desarrollado como Trabajo de Fin de Grado (TFG). SciLens es una plataforma que centraliza el acceso a publicaciones científicas de múltiples fuentes académicas (**arXiv**, **CrossRef** y **Semantic Scholar**), permitiendo buscarlas, compararlas, guardarlas y analizarlas desde una única interfaz moderna.

---

## Características Destacadas

- **Búsqueda Unificada** en arXiv, CrossRef y Semantic Scholar desde una sola interfaz
...
- **Exploración por Áreas** en 12 disciplinas científicas con imágenes de portada
- **Recomendaciones** basadas en las áreas de interés del usuario
- **Autenticación JWT** con roles `usuario` y `admin`
- **Perfil de Usuario** con avatar, áreas de interés y cambio de contraseña
- **Panel de Administración** con gestión de usuarios y analíticas globales
- **Tema Claro/Oscuro** con persistencia via `data-theme`
- **Scroll al inicio** automático en cada cambio de ruta
...
cd frontend
npm install
# Crea frontend/.env con VITE_API_URL=http://localhost:3000/api
...
- Buscar artículos científicos en arXiv, CrossRef y Semantic Scholar simultáneamente
...
| react-router-dom | `^7.13.1` | Enrutamiento SPA + `ScrollToTop` |
...
└── frontend/
    └── src/
        ├── App.tsx               # Router principal, providers y ScrollToTop
        ├── index.css             # Estilos globales (tema claro/oscuro, componentes)
        ├── components/           # Componentes reutilizables
        │   ├── ArticuloCard.tsx
        │   ├── Footer.tsx        # Footer multi-columna (marca, explorar, cuenta, fuentes)
        │   ├── Navbar.tsx
        │   ├── PrivateRoute.tsx
        │   └── SearchBar.tsx
        ├── context/
        ...
        │   ├── HomePage.tsx      # Hero, stats strip, servicios, áreas, about, CTA
        │   ├── BuscarPage.tsx
        │   ├── AreasPage.tsx
        │   ├── AreaDetallePage.tsx
        │   ├── ArticuloPage.tsx
...
|---|---|---|---|
| `/` | `HomePage` | Pública | Hero, stats strip, servicios, áreas, sobre la plataforma, colecciones y CTA |
...
| Semantic Scholar | `https://api.semanticscholar.org/graph/v1` | Ninguna | REST/JSON |
...
- [x] Enrutamiento con React Router DOM + `ScrollToTop` en cada cambio de ruta
...
- [x] Exploración por 12 áreas científicas con imágenes de portada
- [x] Sección "Sobre SciLens" y colecciones destacadas en la portada
...
- [x] Footer multi-columna (marca, explorar, cuenta, fuentes de datos)
- [x] Diseño responsive con breakpoints para mobile, tablet y desktop
